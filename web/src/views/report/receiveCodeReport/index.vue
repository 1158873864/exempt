  ...
  <div class="chart-container">
    ...
    <!-- <chart height="100%" width="100%"/> -->
     <el-table
            ...
            border
            style="width: 100%">
            <el-table-column prop="alipayLoginId" label="alipayLoginId"  align="center"></el-table-column>
            ...
            <el-table-column prop="payMoney" label="payMoney"  align="center"></el-table-column>
